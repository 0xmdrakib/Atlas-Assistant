...
const DICT: Dict = {
  en: {
    ...
    controlsHintBase: "Country + category + window • curated by scoring + caps",
    updatesEvery1h: "updates every 1 hour",
    updatesEvery12h: "updates every 12 hours",
  ...
  bn: {
    ...
    controlsHintBase: "Country + category + window • স্কোরিং + ক্যাপস দিয়ে কিউরেটেড",
    updatesEvery1h: "প্রতি ১ ঘণ্টায় আপডেট",
    updatesEvery12h: "প্রতি ১২ ঘণ্টায় আপডেট",
